...
class CreateAttendancePageWeb extends StatefulWidget {
  ...
  const CreateAttendancePageWeb({Key? key, this.withDuration = false})
      : super(key: key);

  @override
  _CreateAttendancePageWebState createState() =>
      _CreateAttendancePageWebState();
}

class _CreateAttendancePageWebState extends State<CreateAttendancePageWeb> {
